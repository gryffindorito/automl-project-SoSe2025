...
from https://ml.informatik.uni-freiburg.de/research-artifacts/automl-exam-25-vision/vision-phase1.zip  and place them in the `/data` folder
...
This will download the datasets into `./data`, train a dummy AutoML system on _fashion_ and generate predictions for its test
split:
